...
# \file setup.py
#
# \brief Distutils setup script for cyberradiodriver-doc
#
# \author DA
#
...
NAME=CyberRadioDriver.name + "-doc"
# DESCRIPTION: Description of the application
DESCRIPTION=CyberRadioDriver.description + "-- Documentation"
...
DATA_FILE_LIST=[
        ("/usr/share/applications", ["CyberRadioDriver.desktop"]),
    ]
...
DOC_PROJECT_NAME=CyberRadioDriver.name
...
DOC_INSTALL_DIR="/usr/share/doc/%s" % NAME
...
WINDOWS_UPGRADE_CODE="{c700c4a2-7720-4cbd-acd8-84ff7ad10a24}"
