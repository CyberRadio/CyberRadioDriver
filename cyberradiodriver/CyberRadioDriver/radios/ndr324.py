...
class wbddc324(_jsonCommandBase):
    ...
    queryParamMap = {
                ...
                configKeys.FFT_LINK_TYPE : "linktype",
                }
    setParamMap = {
                configKeys.INDEX: "id",
                configKeys.DGS_INDEX: "dgsid",
...
class ndr324(_radio):
    ...
    def getVersionInfo(self):
        ...
        keys = [configKeys.VERINFO_MODEL, configKeys.VERINFO_SN, 
                ...
                configKeys.VERINFO_HW, configKeys.VERINFO_SN ]
        rspInfo = None
    ...
    #    if self.fftCmd is not None:
    #        cmd = self.fftCmd(parent=self, 
    #                          query=True,
    #                          verbose=self.verbose, logFile=self.logFile)
    #        cmd.send( self.sendCommand, )
    #        self._addLastCommandErrorInfo(cmd)
